...
class Sample2 {
    ...
    get MENU1 () {
        return [
            {
                text: 'Right_1',
                value: Sample2Menu1.RIGHT
            },
            {
                text: 'Left_1',
                value: Sample2Menu1.LEFT
            }
        ];
    }

    //ドロップボックスメニュー (Menu2) 
    static get Sample2Menu2 () {
        return Sample2Menu2;
    }
    get MENU2 () {
        return [
            {
                text: 'Right_2',
                value: Sample2Menu2.RIGHT
            },
            {
                text: 'Left_2',
                value: Sample2Menu2.LEFT
            }
        ];
    }
    ...
    getInfo () {
        return {
			...
			TEXT1: {
                            type: ArgumentType.STRING,
                            menu: 'menu1',
                            defaultValue: Sample2Menu1.RIGHT
			},
			NUM1: {
                            type: ArgumentType.NUMBER,
                            defaultValue: 10
			...
			TEXT1: {
                        ...
                        NUM1: {
                            type: ArgumentType.STRING,
			    menu: 'menu2',
                            defaultValue: Sample2Menu2.RIGHT
                        }
                    }
                }
            ],
